...
extension SettingsModelQuerySortBy
  ...
  QueryBuilder<SettingsModel, SettingsModel, QAfterSortBy> sortByToken() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'token', Sort.asc);
    });
  }

  QueryBuilder<SettingsModel, SettingsModel, QAfterSortBy> sortByTokenDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SettingsModelQuerySortThenBy
  ...
  QueryBuilder<SettingsModel, SettingsModel, QAfterSortBy> thenByToken() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'token', Sort.asc);
    });
  }

  QueryBuilder<SettingsModel, SettingsModel, QAfterSortBy> thenByTokenDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'token', Sort.desc);
    });
  }
...
extension SettingsModelQueryWhereDistinct
  ...
  QueryBuilder<SettingsModel, SettingsModel, QDistinct> distinctByImage() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'image');
    });
  }

  QueryBuilder<SettingsModel, SettingsModel, QDistinct> distinctByToken(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SettingsModelQueryProperty
  ...
  QueryBuilder<SettingsModel, List<int>?, QQueryOperations> imageProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'image');
    });
  }

  QueryBuilder<SettingsModel, String?, QQueryOperations> tokenProperty() {
    return QueryBuilder.apply(this, (query) {
